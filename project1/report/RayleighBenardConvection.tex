...
is the \href{https://youtu.be/XdrOHhO4KHQ}{movie}.

\newpage
% temperature image
\begin{center}
\hspace*{-1.0in}
\includegraphics[width=1.40\textwidth]{temperature.png}
\end{center}

% pressure image
\begin{center}
\hspace*{-1.0in}
\includegraphics[width=1.40\textwidth]{pressure.png}
\end{center}

% velocity x image
\begin{center}
\hspace*{-1.0in}
\includegraphics[width=1.40\textwidth]{velocity_x.png}
\end{center}

% velocity y image
\begin{center}
\hspace*{-1.0in}
\includegraphics[width=1.40\textwidth]{velocity_y.png}
\end{center}
...
\begin{center}
\hspace*{-1.0in}
\includegraphics[width=1.40\textwidth]{streamline.png}
\end{center}

% Nusselt number
\begin{center}
\includegraphics[width=0.90\textwidth]{nusselt.png}
\end{center}
\textbf{visualization of vorticity field if possible}
